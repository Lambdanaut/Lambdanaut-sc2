...
MID_GAME_LING_BANE_MUTA += ([ZERGLING] * 24 + [BANELING] * 12) * 2
MID_GAME_LING_BANE_MUTA += [
    HATCHERY,
    QUEEN,
    CENTRIFICALHOOKS,
...
class Builds(enum.Enum):
    ...
    MID_GAME_ROACH_TIMING_ATTACK = 7
    MID_GAME_ROACH_HYDRA_LURKER = 8
