...
MID_GAME_ROACH_HYDRA_LURKER += [BURROW] * 1
MID_GAME_ROACH_HYDRA_LURKER += [INFESTATIONPIT]
MID_GAME_ROACH_HYDRA_LURKER += [HYDRALISK] * 2
MID_GAME_ROACH_HYDRA_LURKER += [TUNNELINGCLAWS]  # Roach burrow move
...
class Builds(enum.Enum):
    ...
    MID_GAME_CORRUPTOR_BROOD_LORD_RUSH = 8

    LATE_GAME_CORRUPTOR_BROOD_LORD = 9
