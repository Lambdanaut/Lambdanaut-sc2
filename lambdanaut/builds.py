...
# Enemy cheese found. Get a spawning pool first with Zerglings and Banelings
...
EARLY_GAME_POOL_FIRST_SPINE_CRAWLER_DEFENSIVE = [
    SPAWNINGPOOL,
    EXTRACTOR,
    OVERLORD,  # 3
    ZERGLING, ZERGLING,
...
MID_GAME_LING_BANE_MUTA += ([ZERGLING] * 24 + [BANELING] * 10) * 3
...
DEFAULT_NEXT_BUILDS_ZERG = {
    ...
    Builds.EARLY_GAME_POOL_FIRST_CAUTIOUS: Builds.MID_GAME_LING_BANE_MUTA,
    Builds.EARLY_GAME_POOL_FIRST_DEFENSIVE: Builds.MID_GAME_LING_BANE_MUTA,
    Builds.EARLY_GAME_HATCHERY_FIRST: Builds.MID_GAME_LING_BANE_MUTA,
    Builds.EARLY_GAME_POOL_FIRST: Builds.MID_GAME_LING_BANE_MUTA,
    Builds.EARLY_GAME_SPORE_CRAWLERS: Builds.MID_GAME_LING_BANE_MUTA,
}
