...
EARLY_GAME_HATCHERY_FIRST_LING_RUSH += [ZERGLING] * 1000
...
class Builds(enum.Enum):
    ...
    MID_GAME_CORRUPTOR_BROOD_LORD_RUSH = 17

    LATE_GAME_CORRUPTOR_BROOD_LORD = 18
    LATE_GAME_ULTRALISK = 19
...
DEFAULT_NEXT_BUILDS = {
    ...
    Builds.EARLY_GAME_HATCHERY_FIRST_LING_RUSH: None,
