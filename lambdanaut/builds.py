...
EARLY_GAME_ROACH_RAVAGER_DEFENSIVE = [
    ...
    ZERGLING, ZERGLING,
    EXTRACTOR,
    DRONE, DRONE, DRONE, DRONE, DRONE, DRONE,  # 23  (More than most early game builds...)
    EXTRACTOR,
    ROACHWARREN,
    ROACH, ROACH, ROACH, ROACH, ROACH, RAVAGER, ROACH, RAVAGER, ROACH, RAVAGER, ROACH, RAVAGER, ROACH, ROACH,
    QUEEN,
    HATCHERY,
    ROACH, ROACH, ROACH, ROACH, RAVAGER,
...
class Builds(enum.Enum):
    ...
    EARLY_GAME_POOL_FIRST = 9
    EARLY_GAME_HATCHERY_FIRST = 10
    EARLY_GAME_HATCHERY_FIRST_GREEDY = 11
    EARLY_GAME_SPORE_CRAWLERS = 12

    MID_GAME_LING_BANE = 13
    MID_GAME_ROACH_HYDRA_LURKER = 14
    MID_GAME_TWO_BASE_ROACH_QUEEN_NYDUS_TIMING = 15
    MID_GAME_CORRUPTOR_BROOD_LORD_RUSH = 16

    LATE_GAME_CORRUPTOR_BROOD_LORD = 17
    LATE_GAME_ULTRALISK = 18
...
DEFAULT_NEXT_BUILDS = {
    ...
    Builds.EARLY_GAME_POOL_FIRST_DEFENSIVE: Builds.EARLY_GAME_DEFAULT_OPENER,
