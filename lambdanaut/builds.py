...
MID_GAME_LING_BANE += ([ZERGLING] * 48 + [BANELING] * 20) * 2
MID_GAME_LING_BANE += [
    CanAfford(BURROW),
...
LATE_GAME_ULTRALISK = [
    ...
    IfHasThenBuild(ZERGGROUNDARMORSLEVEL2, ZERGGROUNDARMORSLEVEL3),
    IfHasThenBuild(ZERGMELEEWEAPONSLEVEL2, ZERGMELEEWEAPONSLEVEL3),
    # If we have a baneling nest, build additional zerglings/banelings until we have an ultralisk cavern
    IfHasThenBuild(BANELINGNEST, IfHasThenDontBuild(ULTRALISKCAVERN, ZERGLING, 20)),
    IfHasThenBuild(BANELINGNEST, IfHasThenDontBuild(ULTRALISKCAVERN, BANELING, 10)),
    ULTRALISKCAVERN,
...
LATE_GAME_CORRUPTOR_BROOD_LORD += [ULTRALISK] * 30
